...
const members = [
    ...
    { name: "shinoji", image: "images/shinoji.webp", roles: ["深夜帯メンション可⭕", "原神民","マイクラ民","第5人格民", "スタレ民","ポケモン民","雀魂民","SAO民","REPO民", "スプラ民","APEX民","ガルパ民","ウマ娘民","NIKKE民", "ゴッフィ民","遊戯王民","PUBGモバイル民","スマブラ民","プリコネ民", "あんスタ民","フォトナ民","スト6の民","アルチキ民","パワプロ民","イナイレ民", "艦これ民", "朝活の民☀️","夜活の民🌙"], comment: "別ゲーの知識が攻略サイト並です🤩" },
    { name: "アスパラゴボウ", image: "images/asupara.PNG", roles: ["深夜帯メンション不可❌", "FGO民", "モンスト民","スタレ民"], comment: "オイっ！オイっ！リアイベで幕張の空気を吸わないと死ぬう！☠️" },
    { name: "桃鍋を許すな", image: "images/momonabe.webp", roles: ["深夜帯メンション不可❌", "TRPG民", "LoL民","メメントモリ民","朝活の民☀️","夜活の民🌙"], comment: "桃鍋を使われたら地の果てまでDAします🔪" },
    { name: "如月アハト", image: "images/Ahato.webp", roles: ["深夜帯メンション可⭕", "FGO民","ポケモン民","モンスト民", "エンドフィールド民","グラブル民","鳴潮民","DDFFの民","SAO民","朝活の民☀️","夜活の民🌙"], comment: "鳴潮ガチです。配信もやってます！✨" },
    { name: "きり/ちえる", image: "images/chikawa.webp", roles: ["深夜帯メンション可⭕", "原神民","マイクラ民","FGO民", "モンスト民","APEX民","ガルパ民","ウマ娘民","ヘブバン民", "パズドラ民","モンハン民","プリコネ民","東方民","ドラクエ民", "OW民(オーバーウォッチ)","朝活の民☀️"], comment: "百合は俺の性域😘" },
    { name: "じろう", image: "images/jiro.PNG", roles: ["深夜帯メンション可⭕","ポケモン民","マイクラ民","Skyの民","REPO民","APEX民","ゴッフィ民","PUBGモバイル民", "アモアス民","シャドバ民","雀魂民","ドラクエ民","第5人格民","夜活の民🌙"], comment: "能ある鷹はFランク🈴" },
    { name: "ティタノマキア", image: "images/makia.PNG", roles: ["深夜帯メンション可⭕", "FGO民","ポケモン民","エンドフィールド民", "ブルアカ民","ステラソラ民"], comment: "低音ヴォイスで敵を沈める🎤" },
    { name: "うに", image: "images/uni.webp", roles: ["深夜帯メンション可⭕", "原神民","マイクラ民","第5人格民", "スタレ民","プロセカ民","ゼンゼロ民","鳴潮民","お絵描き民", "Skyの民","スプラ民","学マス民","ヘブバン民","ゴッフィ民", "NTEの民","ペルソナ民","朝活の民☀️","夜活の民🌙"], comment: "天性のガキンチョ✹" },
    { name: "みかんせいみかん", image: "images/mikan.PNG", roles: ["マイクラ民", "プロセカ民", "シャドバ民","TRPG民","遊戯王民"], comment: "雑多に色々やってます！KP可能なシナリオは数知れず🔥" },
    { name: "らり", image: "images/rari.webp", roles: ["第5人格民", "エンドフィールド民", "Skyの民","あんスタ民"], comment: "推し活がやめられない！❤️‍🔥" },
    { name: "さとつん", image: "images/sato.webp", roles: ["深夜帯メンション可⭕", "FGO民", "雀魂民","グラブル民"], comment: "たっけんをボコボコにします💪" },
    { name: "壁の教祖", image: "images/kyouso.webp", roles: ["深夜帯メンション可⭕", "原神民", "スタレ民","雀魂民", "お絵描き民","DDFFの民", "SAO民", "ブルアカ民","ハリポタ民", "ドラクエ民", "エレナイ民", "朝活の民☀️","壁の教祖"], comment: "壁を愛し壁に愛された教祖👼" },
    { name: "Melon", image: "images/melon.webp", roles: ["深夜帯メンション可⭕", "原神民", "第5人格民","ゼンゼロ民", "スプラ民", "スマブラ民"], comment: "まさか、、フルカノなのか？？？俺はアングリフめぐめぐだ👨‍🦲"},
    { name: "もち", image: "images/moti.webp", roles: ["深夜帯メンション可⭕", "原神民","マイクラ民","第5人格民","スタレ民", "エンドフィールド民","ゼンゼロ民","グラブル民","鳴潮民","アークナイツ民", "REPO民","APEX民","学マス民","ウマ娘民","VARORANT民", "アズールレーン民", "夜活の民🌙"], comment: "アリスとポデンコと莉波を愛するネトゲ廃人　餅食えば運が増すなり確定引き👍" },
